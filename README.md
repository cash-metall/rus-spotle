...
![Артистов](https://img.shields.io/badge/артистов-184-1f6feb?style=flat-square)
...
Код, база из 184 артистов, оформление и даже этот README созданы с помощью ИИ — от первой строчки до последней. Игра целиком живёт в одном `index.html`: никаких зависимостей, CDN и сборки.
...
| **`artists.csv`** | Рабочая база: 184 артиста, 13 жанров. |
